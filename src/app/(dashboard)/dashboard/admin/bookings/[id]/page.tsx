...
import { AdminBookingDetailsView } from "@/components/dashboard/admin/admin-booking-details";
import { getAdminBookingDetails } from "@/lib/dashboard/admin-booking-details";
